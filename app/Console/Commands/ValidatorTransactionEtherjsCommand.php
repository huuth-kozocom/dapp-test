...
class ValidatorTransactionEtherjsCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'validate:metamask-etherjs';
    ...
    {
        parent::__construct();
        $this->transactions = new TransactionEtherjs();
    }
    ...
    {
        $master_account = TransactionEtherjs::MASTER_WALLET; //please paste your master Metamask account address here
